...
namespace Mkey
{
    ...
    public class SlotController : MonoBehaviour
    {
        ...
        private IEnumerator RunSlotsAsync()
        {
            ...
            //MPlayer.SetWinCoinsCount(0); // take win   -------------player coins win count----------------
            ...
            if (winController.HasAnyWinn(ref hasLineWin, ref hasScatterWin, ref  jackPotType))
            {
                ...
                //{
                //    //MPlayer.AddCoins(jackPotWinCoins); -------------jackpot win---------------
            ...
            else // lose
            {
                ...
                //MPlayer.AddLevelProgress(loseSpinLevelProgress); ------------if player lose scenario-----------
